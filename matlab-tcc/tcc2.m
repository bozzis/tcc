...
function tcc ()
    ...
    function S () %Fun��o S, utilizada quando o dia anterior for seco.
        cima = 0; %Parte de cima da fra��o.
        baixo = 0; %Parte de baixo da fra��o.
    ...
    function C () %Fun��o C, utilizada quando o dia anterior for chuvoso. Mesma logica da funcao S.
        cima = 0; %Parte de cima da fra��o.
        baixo = 0; %Parte de baixo da fra��o.
        diafunc=dia;
        if diafunc == 1
